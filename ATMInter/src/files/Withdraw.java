...
String pwd;
    ...
    public Withdraw() {
     ...
     public Withdraw(int username,String pwd) {
       initComponents();
       ImageIcon imageIcon1 = new ImageIcon(new ImageIcon("C:/Users/tyagi/OneDrive/Documents/NetBeansProjects/ATMInter/src/ima/deposite.jpg").getImage().getScaledInstance(background.getWidth(),background.getHeight(), Image.SCALE_DEFAULT));
       background.setIcon(imageIcon1);
       usernm=username;
       this.pwd=pwd;
    }
     public Withdraw(boolean value){
         initComponents();
         if(value==true){
             JOptionPane.showMessageDialog(this,"Amount Is Debited Sucessfully " );
         }
         else{
             JOptionPane.showMessageDialog(this,"YOU HAVE NOT SUFFICIENT BALANCE");
         }
     }
    ...
    private void initComponents() {
        ...
        withdrawl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ima/submit.png"))); // NOI18N
        ...
        jDesktopPane1.add(withdrawl, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 140, 40));

        label1.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        label1.setForeground(new java.awt.Color(255, 255, 255));
        label1.setText("Enter Amount To Be Withdrawl:");
        jDesktopPane1.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 260, 40));

        withdrawlam1.setBorder(null);
        jScrollPane2.setViewportView(withdrawlam1);

        jDesktopPane1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 250, 30));
        ...
        jDesktopPane1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 20, 30, 30));
        jDesktopPane1.add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 290));
    ...
    private void withdrawlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawlActionPerformed
        ...
        MenuPage m=new MenuPage(usernm,pwd);
        this.setVisible(false);
        m.setVisible(true);
    }//GEN-LAST:event_withdrawlActionPerformed

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        MenuPage menuPage=new MenuPage(usernm,pwd);
        this.setVisible(false);
