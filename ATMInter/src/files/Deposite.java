...
public class Deposite extends javax.swing.JFrame {
    ...
    public Deposite(int username,String password){
        initComponents();
        ImageIcon imageIcon = new ImageIcon(new ImageIcon("C:/Users/tyagi/OneDrive/Documents/NetBeansProjects/ATMInter/src/ima/deposite.jpg").getImage().getScaledInstance(background.getWidth(), background.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        jDesktopPane1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 30, 30));

        label1.setBackground(new java.awt.Color(255, 255, 255));
        label1.setFont(new java.awt.Font("Plantagenet Cherokee", 1, 18)); // NOI18N
        label1.setText("Enter amount to be Deposit:");
        jDesktopPane1.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 260, 40));

        deposit.setBackground(new java.awt.Color(0, 255, 255));
        deposit.setFont(new java.awt.Font("Aharoni", 2, 12)); // NOI18N
        deposit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ima/submit.png"))); // NOI18N
        ...
        jDesktopPane1.add(deposit, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 160, 30));

        creditam1.setBorder(null);
        jScrollPane2.setViewportView(creditam1);

        jDesktopPane1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 260, 30));
        jDesktopPane1.add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 250));
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        ...
        Depositam cc=new Depositam(username,amountc,password);
        JOptionPane.showMessageDialog(this,"Amount is credited sucessfully Rs."+amountc );
        MenuPage menuPage=new MenuPage(username,password);
